                ...
                <div className="bg-[#17B8A5] p-8 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <h1 className="text-3xl font-bold text-white mb-1">
                            SIMRS<span className="text-teal-900 opacity-60">HR</span>
                        </h1>
                ...
                <div className="p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-white focus:border-[#17B8A5] focus:ring-2 focus:ring-teal-100 dark:focus:ring-teal-900 outline-none"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-[#17B8A5] hover:bg-[#0F8F80] text-white font-bold py-3.5 rounded-xl shadow-lg transition flex items-center justify-center gap-2 disabled:opacity-70"
                        >
                            {loading ? (
                                <>
